...
class SubscribeApi {
  ...
  SubscribeApi(this._client);

  $async.Future<SubReply> subscribe($pb.ClientContext ctx, SubRequest request) {
    var emptyResponse = SubReply();
    return _client.invoke<SubReply>(ctx, 'Subscribe', 'Subscribe', request, emptyResponse);
  }
}
